...
A = ThermalWall(n = X, p = -L*X, k = k, thermometer = Th, target_temperature = target_temperature, sensitivity = sensitivity)
B = ThermalWall(n = Y, p = -L*Y, k = k, thermometer = Th, target_temperature = target_temperature, sensitivity = sensitivity)
C = ThermalWall(n = Z, p = -L*Z, k = k, thermometer = Th, target_temperature = target_temperature, sensitivity = sensitivity)
D = ThermalWall(n = -X, p = L*X, k = k, thermometer = Th, target_temperature = target_temperature, sensitivity = sensitivity)
E = ThermalWall(n = -Y, p = L*Y, k = k, thermometer = Th, target_temperature = target_temperature, sensitivity = sensitivity)
F = ThermalWall(n = -Z, p = L*Z, k = k, thermometer = Th, target_temperature = target_temperature, sensitivity = sensitivity)
